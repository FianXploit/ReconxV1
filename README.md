<!--
 ╔═══════════════════════════════════════════════════════════════╗
 ║  🛰️  ReconX v3 — Web Reconnaissance & Analysis Tool         ║
 ║  Author: FianDev                                            ║
 ║  Version: 3.0.0                                             ║
 ╚═══════════════════════════════════════════════════════════════╝
-->
...
<h1 align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=500&color=00FF00&center=true&vCenter=true&width=500&lines=ReconX+v3;Web+Recon+%26+Analysis;CDN+Detect+%E2%80%A2+CMS+Scan+%E2%80%A2+UA+Rotate" alt="Typing SVG" />
</h1>
...
**ReconX v3** adalah tools otomatis untuk *web reconnaissance* dan *security analysis* yang menggabungkan DNS resolver, CDN detection, CMS fingerprinting, security header audit, dan port scanning dalam satu perintah. Cocok untuk:
